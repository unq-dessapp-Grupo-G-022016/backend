...
public class AttendersRepository extends HibernateGenericRepository<Attenders> implements GenericRepository<Attenders> {
    ...
    @Override
    protected Class<Attenders> getDomainClass() {
        return Attenders.class;
    }
}
